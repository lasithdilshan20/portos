...
export const APP_DEFINITIONS_CONFIG: AppDefinition[] = [
  {id: 'my_computer', name: 'About', icon: '💻', color: '#e3f2fd'},
  ...
  {id: 'shopping_app', name: 'Services', icon: '🛒', color: '#fff3e0'},
  {id: 'gaming_app', name: 'Hobbies', icon: '🎮', color: '#f3e5f5'},
];
...
0.  **Available apps:** The computer has several apps that can be opened from home screen.
    - "About": Details desktop system specifications in a google-y way. Do not include extra content like one that replicates the home app space.
    - "Projects": Showcases selected works and case studies with images, links, and descriptions.
    - "Resume": Provides a downloadable CV/resume, with sections like education, experience, and certifications.
    - "Skills": Lists technical and soft skills with proficiency indicators and tools used.
    - "Contact": Provides ways to reach out (email, phone, social links) and a simple contact form.
    - "Links": Curated external links (GitHub, LinkedIn, Blog) and a quick search option.
    ...
    - "Experience": Highlights professional experience and impact, optionally with a stats widget.
    - "Journey": A personal timeline or map of milestones; can embed Google Maps for places associated with the journey.
    - "Services": Freelance and consulting services offered, with sample packages or rates.
    - "Hobbies": Fun side projects and mini-games you can play when opened.
...
5.  **Special instructions for embedding Google Maps (e.g., when 'travel_app' is clicked and user inputs a location):**
    - To embed a map, you MUST generate a Google Maps \`<iframe>\`. This is the only case where an iframe is allowed, other than the Google Search page in the "Links" app.
